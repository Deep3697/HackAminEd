  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl z-10"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-lg shadow-blue-500/20">
            <span className="text-2xl font-bold text-white tracking-wider">TM</span>
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">TechMicra ERP</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <input
              ...
              placeholder="admin@techmicra.com"
              required
            />
          </motion.div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full bg-blue-600 text-white font-semibold py-3.5 px-4 rounded-xl transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)]"
          >
            Authenticate
          </motion.button>
        </form>
